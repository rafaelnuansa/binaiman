...
<a class="group hover:bg-gray-100 rounded-xl p-2 transition-all dark:hover:bg-white/[.05]"
    href="{{ $slug }}">
    <div
        class="flex-shrink-0 relative rounded-xl overflow-hidden w-full h-[200] before:absolute before:inset-x-0 before:w-full before:h-full before:bg-gradient-to-t before:from-gray-900/[.7] before:z-[1]">
        <img class="w-full object-cover rounded-xl" src="{{ $image }}"
         alt="{{ $title }}"
