<section class="lg:pb-40 lg:pt-56 py-32 relative" id="home">
    <div class="overflow-hidden">
        <img class="absolute inset-0 h-full w-full object-cover"
            src="https://images.unsplash.com/photo-1621841818525-5a3ec7067a41?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1080&q=80"
            alt="build your website">
        <div class="absolute inset-0 bg-gradient-to-tr from-[#017534] to-[#381704] opacity-60"></div>
    </div>
            ...
            <div class="lg:w-2/3 text-center relative">
                <div class="space-y-6 mb-10">
                    ...
                    <p class="text-gray-100 text-base md:text-lg animate__animated animate__fadeInUp">
                        Memberikan kontribusi nyata dalam pembangunan sumber daya manusia dan menciptakan insan kamil
