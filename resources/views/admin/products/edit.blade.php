            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="content" class="form-control @error('content') is-invalid @enderror" name="content" required>{{ old('content', $product->content) }}</textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="owner" type="text" class="form-control @error('owner') is-invalid @enderror" name="owner" value="{{ old('owner', $product->owner) }}" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', $product->phone) }}" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" required>{{ old('address', $product->address) }}</textarea>
