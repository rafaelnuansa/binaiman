...
Route::prefix('public')->group(function () {
    ...
    //index products home
    Route::get('/products_categories', [App\Http\Controllers\Api\Public\ProductController::class, 'categories']);

    //index products
    Route::get('/wisata', [App\Http\Controllers\Api\Public\WisataController::class, 'index']);

    //show page
    Route::get('/wisata/{slug}', [App\Http\Controllers\Api\Public\WisataController::class, 'show']);

    //index wisata home
    Route::get('/wisata_home', [App\Http\Controllers\Api\Public\WisataController::class, 'homePage']);

    
    //index wisata home
    Route::get('/wisata_categories', [App\Http\Controllers\Api\Public\WisataController::class, 'categories']);
